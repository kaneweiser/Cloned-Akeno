...
class Config(object):
    ...
    API_HASH = "awoo"
    TOKEN = "1422638635:AAEIFWpaB_IjG9cWSwmQ-0D8L9AWsXMcCMA"  #This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    OWNER_ID = 1364874872  # If you dont know, run the bot and do /id in your private chat with it, also an integer
    OWNER_USERNAME = "no_phd"
